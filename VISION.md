...
1. [An Invidual Memex](#an-invidual-memex)
1. [A Collective Memex](#a-collective-memex)
   1. [A Protocol for Bi-directionality](#a-protocol-for-bi-directionality)
   1. [A Protocol for Knowledge Markets](#a-protocol-for-knowledge-markets)
1. [A Community for Collaboration, Learning, and Invention]([1])

[1]: #a-community-for-collaboration,-learning,-and-invention

> There is nothing impossible to him (or her) who will try.

— Alexander the Great

This document can be read alongside [Athens Roadmap Mindmap v2](https://www.notion.so/athensresearch/Athens-Roadmap-Mindmap-v2-096427f189b648729ae0acbdcefd4c6f?showMoveTo=true).
...
This isn't about Roam's ethics, either. This is about users putting their second brains — their entire lives — on a public cloud. In plain-text. To be summoned at will by the government (see [Facebook Transparency Report](https://transparency.facebook.com/government-data-requests/country/US), [Google Transparency Report](https://transparencyreport.google.com/user-data/overview?hl=en)).
...
# A Community for Collaboration, Learning, and Invention

Lastly, the final Athens vision is for everyone, one day, to learn how to learn anything.

To do that, it is mission critical to create a space and culture where we can [work with one another, learn from one another, and create with one another](https://github.com/athensresearch/athens/blob/master/CODE_OF_CONDUCT.md).
